              ...
              <div style={{ display: "flex" }}>
                {comment.isAdmin ? (
                  <div className="all-comment-info-name admin">
                    <img src="https://png.pngtree.com/png-clipart/20200727/original/pngtree-smartphone-shop-sale-logo-design-png-image_5069958.jpg"></img>
                  </div>
                ) : (
      ...
      {/* <Col span={18}>
          ...
          </Col>
          {
            ...
            <div className="comment-area" style={{display: 'flex', alignItems:'center'}}>
              <textarea placeholder='Xin mời để lại câu hỏi, PhoneStore sẽ trả lời trong 1h từ 8h - 22h mỗi ngày.' rows={10} cols={3}></textarea>
            </div>
            <div className="comment-send">
